...
// perception — green vs. black in particular look similar at a glance on a small phone screen.
const SUIT_LABEL: Record<string, string> = { green: "녹", yellow: "황", purple: "보", black: "흑" };
