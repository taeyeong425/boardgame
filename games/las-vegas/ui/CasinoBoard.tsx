...
export function CasinoBoard({
  ...
  return (
    <div className="flex flex-col gap-1.5 rounded-lg border border-white/10 bg-white/5 p-3 text-sm">
      <div className="flex items-center justify-between gap-1">
        <span className="rounded-full bg-white/10 px-2.5 py-1 text-base font-bold">{casino.number}</span>
